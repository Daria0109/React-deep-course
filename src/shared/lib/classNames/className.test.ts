...
describe(
	'ClassNames', () => {
		test(
			'Main class should be returned', () => {
				expect(classNames('mainClass')).toBe('mainClass');
			}
		);

		test(
			'Main and extra classes should be returned', () => {
				expect(classNames(
					'mainClass', {}, ['extraClass1', 'extraClass2']
				))
		...
		test(
			'Main, extra and mods classes should be returned', () => {
				expect(classNames(
					'mainClass',
		...
		test(
			'Mods false should return correctly', () => {
				expect(classNames(
					'mainClass',
		...
		test(
			'Mods undefined should return correctly', () => {
				expect(classNames(
					'mainClass',
